...
try {
    ...
    $maintenanceTypes = ['missing_reports', 'report_migration', 'phoenix_pdf_restore', 'measurement_migration', 'inspection_data_migration', 'legacy_classification_migration', 'import_result_reconciliation', 'vocabulary_suggestion', 'vocabulary_normalization'];
