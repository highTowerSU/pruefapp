...
class AdminController
{
    ...
    public static function inspectionApiDebug(array $params, bool $isHx): array
    {
        ...
        $maintenanceTypes = ['legacy_classification_migration', 'import_result_reconciliation', 'csv_source_fact_reconciliation', 'inspection_duplicate_audit', 'inspection_duplicate_archive', 'inspection_json_csv_mirror_archive', 'inspection_csv_source_duplicate_archive', 'inspection_manual_csv_consolidation', 'all_report_regeneration'];
    ...
    private static function inspectionDuplicatesApiDebug(array $headers): array
    {
        ...
        ], array_filter(BackgroundJobService::pending(200), static fn(array $job): bool => in_array((string) ($job['type'] ?? ''), ['inspection_duplicate_audit', 'csv_source_fact_reconciliation', 'inspection_duplicate_archive', 'inspection_json_csv_mirror_archive', 'inspection_csv_source_duplicate_archive'], true))));
