...
$routes = [
    ...
    ['POST', '/downloads/was-ist-neu/{id}/erledigt', fn($params, $isHx) => DownloadController::markWhatsNewChecked($params, $isHx)],
    ['POST', '/downloads/was-ist-neu/alle/erledigt', fn($params, $isHx) => DownloadController::markAllWhatsNewChecked($params, $isHx)],
    ...
    ['POST', '/geraete/speicherplaetze/form', fn($params, $isHx) => DeviceController::storageSlotRows($params, $isHx)],
    ...
    ['POST', '/admin/abrechnung/sevdesk-synchronisieren', fn($params, $isHx) => BillingController::syncSevDeskInvoices($params, $isHx)],
    ...
    ['POST', '/admin/abrechnung/rechnung/{id}/regie-uebertragen', fn($params, $isHx) => BillingController::transferRegie($params, $isHx)],
