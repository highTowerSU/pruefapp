...
$structureMediaService = (string) file_get_contents(dirname(__DIR__) . '/lib/StructureMediaService.php');
$structureMediaController = (string) file_get_contents(dirname(__DIR__) . '/controllers/StructureMediaController.php');
$structureMediaPanel = (string) file_get_contents(dirname(__DIR__) . '/templates/structure_media_panel.php');
