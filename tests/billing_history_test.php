...
$checks = [
    ...
    [str_contains($billing, 'billed_regie_minutes') && str_contains($detail, 'Rechnungs-Regie') && str_contains($detail, 'Phoenix-Importprüfungen'), 'Historische Rechnungsregie wird weder in der Vorschau noch im CSV als Abrechnungszuordnung geführt.'],
