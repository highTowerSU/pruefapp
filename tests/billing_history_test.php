...
$checks = [
    ...
    [str_contains($maintenance, 'allReportRegeneration') && str_contains($cron, 'benning-import-regie:v2') && str_contains($cron, 'all-reports-after-benning-regie:v3') && str_contains($cron, 'supersedePendingType') && str_contains($cron, 'hasPairedRegieSource') && str_contains($cron, 'hasJsonlRegieSource') && str_contains($cron, 'benning_import_regie_reimport_version') && str_contains($cron, 'benning_import_regie_reports_version'), 'Der Regie-Reimport stößt keine fortsetzbare Neuerzeugung aller aktuellen Prüfberichte an.'],
