...
if (!str_contains($service, 'ReleaseNotePublisher::publishForUser') || !str_contains($downloads, "render_template('_whats_new.php'") || !str_contains($whatsNewTemplate, 'id="whats-new"') || !str_contains($whatsNewTemplate, 'Alle abhaken')) {
