...
$checks = [
    ...
    [str_contains($controller, 'notificationDropdownFragment') && str_contains($controller, 'downloads-notifications'), 'Gelesen-Aktionen liefern keine passende HTMX-Teilansicht zurück.'],
    ...
    [str_contains($list, 'hx-target="#downloads-notifications"') && str_contains($list, 'hx-swap="outerHTML"'), 'Die Download-Übersicht aktualisiert Benachrichtigungen nicht ohne Seitenreload.'],
];
