...
$checks = [
    ...
    [str_contains($template, 'data-action-nav="Geräteaktionen"') && str_contains($template, 'id="device-actions-panel"') && str_contains($template, 'class="card mb-3" open') && str_contains($template, 'data-action-nav="Neues Gerät"') && str_contains($template, 'data-action-nav="Neue Prüfung"'), 'Die Geräteaktionen oder Schnellzugriffe sind nicht sichtbar markiert.'],
