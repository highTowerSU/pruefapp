...
- **Mehrere Prüf-Speicherplätze:** Geräte mit mehreren Netzteilen können mehrere Speicherplatznummern mit je einem optionalen Kommentar hinterlegen. Zusätzliche Zeilen werden im Geräteformular per HTMX ergänzt, ohne andere Eingaben neu zu laden.
