...
/** @var array<int, array<string, string>> $certificates */
 ...
 $displayPreference = $displayPreference ?? ['theme' => 'auto', 'contrast' => 'standard', 'font_scale' => 'standard', 'font_weight' => 'standard', 'font_family' => 'system', 'motion' => 'system'];
?>
...
<section class="card shadow-sm mb-4" id="display-preferences" data-action-nav="Darstellung" data-action-icon="fa-universal-access">
  ...
  <div class="card-body">
    ...
    <?php if ($canEdit): ?><form method="post" action="<?= htmlspecialchars($profileUrl, ENT_QUOTES) ?>" class="row g-3" data-display-preferences-form><input type="hidden" name="action" value="save_display_preferences">
      ...
      <div class="col-12 col-md-6"><label class="form-label" for="display-contrast">Kontrast</label><select class="form-select" id="display-contrast" name="contrast"><option value="standard"<?= $displayPreference['contrast'] === 'standard' ? ' selected' : '' ?>>Standard</option><option value="system"<?= $displayPreference['contrast'] === 'system' ? ' selected' : '' ?>>Betriebssystem-Hochkontrast</option><option value="white_black"<?= $displayPreference['contrast'] === 'white_black' ? ' selected' : '' ?>>Schwarz / Weiß</option><option value="yellow_black"<?= $displayPreference['contrast'] === 'yellow_black' ? ' selected' : '' ?>>Schwarz / Gelb</option><option value="green_black"<?= $displayPreference['contrast'] === 'green_black' ? ' selected' : '' ?>>Schwarz / Grün</option></select></div>
      <div class="col-12 col-md-6"><label class="form-label" for="display-font-scale">Leseschrift</label><select class="form-select" id="display-font-scale" name="font_scale"><option value="standard"<?= $displayPreference['font_scale'] === 'standard' ? ' selected' : '' ?>>Standardgröße (100 %)</option><option value="large"<?= $displayPreference['font_scale'] === 'large' ? ' selected' : '' ?>>Größer (112 %)</option><option value="xlarge"<?= $displayPreference['font_scale'] === 'xlarge' ? ' selected' : '' ?>>Sehr groß (125 %)</option><option value="xxlarge"<?= $displayPreference['font_scale'] === 'xxlarge' ? ' selected' : '' ?>>Extra groß (140 %)</option></select><div class="form-text">Die Inhalte wachsen ohne Browser-Zoom; für noch größere Darstellung bleibt der Browser-Zoom nutzbar.</div></div>
      <div class="col-12 col-md-6"><label class="form-label" for="display-font-family">Schriftart</label><select class="form-select" id="display-font-family" name="font_family"><option value="system"<?= $displayPreference['font_family'] === 'system' ? ' selected' : '' ?>>Systemschrift (empfohlen)</option><option value="sans"<?= $displayPreference['font_family'] === 'sans' ? ' selected' : '' ?>>Klarer Sans-Serif</option><option value="serif"<?= $displayPreference['font_family'] === 'serif' ? ' selected' : '' ?>>Serifenschrift</option><option value="mono"<?= $displayPreference['font_family'] === 'mono' ? ' selected' : '' ?>>Festbreite</option></select><div class="form-text">Es werden nur lokal verfügbare Systemschriften verwendet.</div></div>
      ...
      <div class="col-12"><div class="form-check form-switch"><input class="form-check-input" type="checkbox" role="switch" id="display-font-weight" name="font_weight" value="bold"<?= $displayPreference['font_weight'] === 'bold' ? ' checked' : '' ?>><label class="form-check-label" for="display-font-weight">Text stärker darstellen</label></div><div class="form-text">Erhöht die Lesbarkeit von Fließtext, Tabellen und Formularen; Symbole und Überschriften bleiben unverändert.</div></div>
