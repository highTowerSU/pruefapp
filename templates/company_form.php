...
<form method="post" class="card shadow-sm border-0" enctype="multipart/form-data">
  <div class="card-body">
    ...
    <div class="row g-4 mb-4">
      ...
      <div class="col-md-6"><label class="form-label" for="sevdesk_contact_person_id">SevDesk-Ansprechperson (Benutzer-ID)</label><input type="text" inputmode="numeric" pattern="[0-9]*" class="form-control" id="sevdesk_contact_person_id" name="sevdesk_contact_person_id" value="<?= htmlspecialchars((string) ($company['sevdesk_contact_person_id'] ?? '')) ?>" placeholder="optional"><div class="form-text">Optional bei genau einem SevDesk-Benutzer; bei mehreren Konten bitte die Benutzer-ID der rechnungsstellenden Person eintragen.</div></div>
    </div>
