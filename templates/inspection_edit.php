...
<div class="col-md-3"><label class="form-label"><i class="fa-solid fa-hard-drive me-1" aria-hidden="true"></i>Speicherplatz</label><input class="form-control" name="storage_slot" value="<?= htmlspecialchars((string) $inspection->storage_slot) ?>" placeholder="wird nach Messung eingetragen"></div>
...
@media(max-width:575.98px){.connector-grid{gap:.6rem}.connector-example{grid-template-rows:72px auto;padding:.45rem}.connector-example img{height:68px}.connector-empty{min-height:200px}}
</style>
<script>
(() => {
