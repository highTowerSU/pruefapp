...
<div class="col-md-3"><label class="form-label">Prüfnummer</label><input class="form-control" name="external_number" value="<?= htmlspecialchars((string) $inspection->external_number) ?>" required><div class="form-text">Für neue Etiketten überschreibbar.</div></div><div class="col-md-3"><label class="form-label">Alte Prüfnummer</label><input class="form-control" name="legacy_number" value="<?= htmlspecialchars((string) ($inspection->legacy_number ?? '')) ?>" placeholder="optional"></div><div class="col-md-3"><label class="form-label">Prüfdatum</label><input class="form-control" type="date" name="test_date" value="<?= htmlspecialchars((string) $inspection->test_date) ?>" required><div class="form-text">Vorausgefüllt, bei Bedarf änderbar.</div></div><div class="w-100"></div>
