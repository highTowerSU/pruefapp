...
<style>
  ...
  @container (min-width: 34rem){.media-upload-layout{grid-template-columns:minmax(0,1fr) minmax(10rem,.55fr);grid-template-areas:"source type" "source caption" "hint action"}.media-upload-source{grid-area:source}.media-upload-type{grid-area:type}.media-upload-caption{grid-area:caption}.media-upload-hint{grid-area:hint}.media-upload-action{grid-area:action}.media-upload-layout-simple{grid-template-areas:"source source" "hint action"}}
  @container (min-width: 54rem){.media-upload-layout{grid-template-columns:minmax(15rem,1.05fr) minmax(10rem,.48fr) minmax(16rem,1fr);grid-template-areas:"source type caption" "source hint action"}.media-upload-layout-simple{grid-template-areas:"source hint action"}}
