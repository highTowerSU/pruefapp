<div class="card shadow-sm">
  <div class="card-body">
    ...
    <form method="post" class="row g-3">
      ...
      <div class="col-md-3"><label class="form-label" for="legacy-date"><i class="fa-solid fa-calendar-day me-1" aria-hidden="true"></i>Prüfdatum *</label><input class="form-control" id="legacy-date" type="date" name="test_date" value="<?= htmlspecialchars((string) $inspection->test_date, ENT_QUOTES) ?>" required></div>
      <div class="col-md-3"><label class="form-label" for="legacy-due"><i class="fa-solid fa-calendar-check me-1" aria-hidden="true"></i>Nächstes Prüfdatum *</label><input class="form-control" id="legacy-due" type="date" name="next_due_date" value="<?= htmlspecialchars((string) $inspection->next_due_date, ENT_QUOTES) ?>" required></div>
