...
<form id="device-bulk-form" method="post" action="<?= htmlspecialchars(url_for('geraete/massenaktion'), ENT_QUOTES) ?>" class="card card-body mb-3">
  <div class="d-flex flex-wrap align-items-center gap-2">
    ...
    <label class="small" for="device-bulk-scope">Auswahl <select class="form-select form-select-sm d-inline-block w-auto" id="device-bulk-scope" name="selection_scope" data-no-search><option value="selection" selected>Markierte Geräte</option><option value="all">Alle gefilterten Seiten</option><option value="page">Aktuelle Seite</option></select></label>
    <input type="hidden" name="filter_query" value="">
