...
<section id="device-inspection-lookup" class="card card-body mb-4 device-new-inspection" aria-labelledby="device-inspection-lookup-title">
  <div class="row g-3 align-items-end">
    <div class="col-lg-5">
      ...
      <p class="small text-body-secondary mb-2">Gerätenummer eingeben oder den Barcode mit einem angeschlossenen Scanner erfassen.</p><button class="btn btn-sm btn-secondary" type="button" data-companion-connect-info><i class="fa-solid fa-mobile-screen-button me-1" aria-hidden="true"></i>Companion-App</button>
    </div>
    <div class="col-lg-7">
