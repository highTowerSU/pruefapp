...
?>
  <form method="post" action="<?= htmlspecialchars(url_for('geraete'), ENT_QUOTES) ?>" enctype="multipart/form-data" class="row g-3 device-form">
    ...
    <div class="col-12 device-form-actions"><div class="d-flex flex-wrap align-items-center gap-2"><button type="button" class="btn btn-sm btn-primary" data-copy-device-name disabled><i class="fa-solid fa-wand-magic-sparkles me-1" aria-hidden="true"></i><span data-copy-device-name-label>Passende Bezeichnung vorschlagen</span></button><span class="small text-body-secondary">Nach der Modellwahl wird eine Vorschau angezeigt.</span></div></div>
