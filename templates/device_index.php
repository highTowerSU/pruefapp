...
$form = static function ($device = null, string $newNumber = '') use ($rooms, $roomLabels, $manufacturerOptions, $modelOptions, $nameOptions, $modelOptionsByManufacturer, $nameOptionsByManufacturerModel, $suggestedDeviceNumber, $inspectionTypes): void {
