...
<?php if (!empty($canManage)): ?><form id="device-export-form" method="post" action="<?= htmlspecialchars(url_for('geraete/export'), ENT_QUOTES) ?>" class="card card-body mb-3">
  <div class="d-flex flex-wrap align-items-end gap-2">
    ...
    <button class="btn btn-sm btn-outline-secondary" type="button" id="device-mark-page">Seite markieren</button><button class="btn btn-sm btn-outline-secondary" type="button" id="device-unmark-page">Seite demarkieren</button><button class="btn btn-sm btn-outline-secondary" type="button" id="device-mark-all">Alle Seiten markieren</button><button class="btn btn-sm btn-outline-secondary" type="button" id="device-unmark-all">Alle Seiten demarkieren</button><label class="small d-flex align-items-center gap-1">Max. Seiten <input class="form-control form-control-sm" style="width:5rem" type="number" min="10" max="5000" name="bundle_max_pages" value="500"></label><button class="btn btn-sm btn-outline-primary" name="format" value="csv">CSV</button><button class="btn btn-sm btn-outline-primary" name="format" value="ods">ODS</button><button class="btn btn-sm btn-outline-primary" name="format" value="xlsx">XLSX</button><button class="btn btn-sm btn-outline-primary" name="format" value="pdf">PDF</button><button class="btn btn-sm btn-outline-primary" name="format" value="json">JSON</button><button class="btn btn-sm btn-outline-success" name="format" value="zip_latest">ZIP letzte PDFs</button><button class="btn btn-sm btn-outline-success" name="format" value="zip_all">ZIP alle PDFs</button><button class="btn btn-sm btn-success" name="format" value="bundle_pdf">Sammel-PDF mit Inhaltsverzeichnis</button>
