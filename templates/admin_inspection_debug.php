<div class="container py-4" id="inspection-debug-page">
  ...
  <section class="card mb-4">
    ...
    <div class="card-body">
      <p class="small text-body-secondary">Der einmalige Hintergrundlauf sucht gleiche Prüfnummern am selben Gerät, Import-Suffixe wie „-25-2“ und genau zwei Prüfungen desselben Geräts innerhalb von 180 Tagen. Dichte historische Verläufe werden nicht als unübersichtliche Paarmatrix ausgegeben. Der Lauf verändert weder Prüfungen noch Rechnungen; besonders bei bereits bezahlten historischen Rechnungen bleibt die Entscheidung bewusst manuell.</p>
