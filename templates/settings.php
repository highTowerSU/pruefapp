...
<form method="post" action="<?= htmlspecialchars(url_for('admin/konfiguration'), ENT_QUOTES) ?>" class="card shadow-sm mb-4">
  ...
  <div class="card-body">
    ...
    <hr>
    <h3 class="h6"><i class="fa-solid fa-list-ol me-1" aria-hidden="true"></i>Aufbewahrung der Cron-Protokolle</h3>
    <p class="small text-body-secondary">Technische Cron-Logs werden automatisch nach dem FIFO-Prinzip bereinigt. Fachliche Audit- und Revisionsdaten bleiben erhalten.</p>
    <div class="row g-3">
