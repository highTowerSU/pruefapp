...
?>
<details class="card mb-3" id="<?= $panelId ?>"<?= $inspectionMedia !== [] ? ' open' : '' ?>>
  <summary class="card-header fw-semibold"><i class="fa-solid fa-camera me-2" aria-hidden="true"></i>Fotodokumentation <span class="small text-body-secondary fw-normal">optional</span><?php if ($inspectionMedia !== []): ?><span class="badge text-bg-secondary ms-2"><?= count($inspectionMedia) ?></span><?php endif; ?></summary>
  <div class="card-body">
