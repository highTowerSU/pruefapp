...
<section class="border rounded-3 p-3 mb-3" id="<?= $panelId ?>">
  ...
  <?php if ($canManageMedia): ?><?= render_template('media_upload_component.php', ['componentId' => 'inspection-photo-' . (int) $inspection->id, 'action' => url_for('pruefungen/' . (int) $inspection->id . '/fotos'), 'hxTarget' => '#' . $panelId, 'allowTypePlate' => false]) ?><?php endif; ?>
</section>
