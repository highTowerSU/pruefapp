...
function ensure_structure_schema(): void
{
    ...
    $statements = [
        ...
        "CREATE TABLE IF NOT EXISTS userdisplaypreference (id INTEGER PRIMARY KEY AUTOINCREMENT, oauthuser_id INTEGER NOT NULL UNIQUE, theme TEXT NOT NULL DEFAULT 'auto', contrast TEXT NOT NULL DEFAULT 'standard', font_scale TEXT NOT NULL DEFAULT 'standard', font_weight TEXT NOT NULL DEFAULT 'standard', motion TEXT NOT NULL DEFAULT 'system', updated_at TEXT NULL)",
    ...
    $columns = [
        ...
        'userdisplaypreference' => ['font_weight' => "TEXT NOT NULL DEFAULT 'standard'"],
    ];
