...
function ensure_structure_schema(): void
{
    ...
    $statements = [
        ...
        "CREATE TABLE IF NOT EXISTS user_display_preference (id INTEGER PRIMARY KEY AUTOINCREMENT, oauthuser_id INTEGER NOT NULL UNIQUE, theme TEXT NOT NULL DEFAULT 'auto', contrast TEXT NOT NULL DEFAULT 'standard', font_scale TEXT NOT NULL DEFAULT 'standard', motion TEXT NOT NULL DEFAULT 'system', updated_at TEXT NULL)",
