...
require_once __DIR__ . '/ApplicationFailureService.php';
...
function ensure_structure_schema(): void
{
    ...
    $statements = [
        ...
        "CREATE TABLE IF NOT EXISTS importrebuildrun (id INTEGER PRIMARY KEY AUTOINCREMENT, public_id TEXT NOT NULL UNIQUE, source_directory TEXT NOT NULL, backup_path TEXT NOT NULL DEFAULT '', state TEXT NOT NULL DEFAULT 'staging', created_by INTEGER NULL, created_at TEXT NOT NULL, completed_at TEXT NULL, summary_json TEXT NOT NULL DEFAULT '{}')",
        "CREATE TABLE IF NOT EXISTS importcandidate (id INTEGER PRIMARY KEY AUTOINCREMENT, run_id INTEGER NOT NULL, group_key TEXT NOT NULL DEFAULT '', source_kind TEXT NOT NULL, source_path TEXT NOT NULL DEFAULT '', source_row_no INTEGER NOT NULL DEFAULT 0, source_inspection_id INTEGER NULL, inspection_number TEXT NOT NULL DEFAULT '', device_number TEXT NOT NULL DEFAULT '', legacy_device_number TEXT NOT NULL DEFAULT '', test_date TEXT NOT NULL DEFAULT '', inspection_type TEXT NOT NULL DEFAULT '', storage_slot TEXT NOT NULL DEFAULT '', raw_json TEXT NOT NULL DEFAULT '{}', state TEXT NOT NULL DEFAULT 'open', decision_json TEXT NOT NULL DEFAULT '{}', created_at TEXT NOT NULL)",
        ...
        "CREATE TABLE IF NOT EXISTS billinginvoice (id INTEGER PRIMARY KEY AUTOINCREMENT, customer_id INTEGER NULL, tenant_id INTEGER NULL, sevdesk_invoice_id TEXT NOT NULL DEFAULT '', sevdesk_invoice_number TEXT NOT NULL DEFAULT '', sevdesk_url TEXT NOT NULL DEFAULT '', invoice_number TEXT NOT NULL DEFAULT '', invoice_date TEXT NULL, status TEXT NOT NULL DEFAULT 'draft', error_details TEXT NOT NULL DEFAULT '', created_by INTEGER NULL, exported_by TEXT NOT NULL DEFAULT '', exported_at TEXT NULL, amount_net REAL NULL, amount_gross REAL NULL, created_at TEXT NULL, updated_at TEXT NULL)",
        "CREATE TABLE IF NOT EXISTS billinginvoiceitem (id INTEGER PRIMARY KEY AUTOINCREMENT, invoice_id INTEGER NOT NULL, inspection_id INTEGER NOT NULL, device_id INTEGER NOT NULL, quantity REAL NOT NULL DEFAULT 1, description TEXT NOT NULL DEFAULT '', active INTEGER NOT NULL DEFAULT 1, assigned_at TEXT NULL, deactivated_at TEXT NULL, deactivation_reason TEXT NOT NULL DEFAULT '', source TEXT NOT NULL DEFAULT 'sevdesk', created_at TEXT NULL)",
        "CREATE TABLE IF NOT EXISTS billinginvoiceposition (id INTEGER PRIMARY KEY AUTOINCREMENT, invoice_id INTEGER NOT NULL, sevdesk_position_id TEXT NOT NULL DEFAULT '', position_number TEXT NOT NULL DEFAULT '', name TEXT NOT NULL DEFAULT '', details TEXT NOT NULL DEFAULT '', quantity REAL NOT NULL DEFAULT 0, unit TEXT NOT NULL DEFAULT '', kind TEXT NOT NULL DEFAULT 'unclassified', suggested_kind TEXT NOT NULL DEFAULT '', regie_minutes INTEGER NOT NULL DEFAULT 0, raw_json TEXT NOT NULL DEFAULT '{}', created_at TEXT NULL, updated_at TEXT NULL, UNIQUE(invoice_id, sevdesk_position_id))",
        "CREATE TABLE IF NOT EXISTS billinginvoiceitemposition (id INTEGER PRIMARY KEY AUTOINCREMENT, invoice_item_id INTEGER NOT NULL, invoice_position_id INTEGER NOT NULL, allocation_kind TEXT NOT NULL DEFAULT 'device', created_at TEXT NULL, UNIQUE(invoice_item_id, invoice_position_id, allocation_kind))",
        "CREATE TABLE IF NOT EXISTS billingregietransfer (id INTEGER PRIMARY KEY AUTOINCREMENT, source_invoice_id INTEGER NOT NULL, source_position_id INTEGER NOT NULL, target_invoice_id INTEGER NOT NULL, target_position_id INTEGER NOT NULL, minutes INTEGER NOT NULL, reason TEXT NOT NULL DEFAULT '', transferred_by INTEGER NULL, active INTEGER NOT NULL DEFAULT 1, created_at TEXT NOT NULL, reversed_at TEXT NULL, reversal_reason TEXT NOT NULL DEFAULT '')",
        "CREATE TABLE IF NOT EXISTS inspectiondupreview (id INTEGER PRIMARY KEY AUTOINCREMENT, inspection_id INTEGER NOT NULL, peer_inspection_id INTEGER NOT NULL, device_id INTEGER NOT NULL, finding_type TEXT NOT NULL, severity TEXT NOT NULL DEFAULT 'warning', reason TEXT NOT NULL DEFAULT '', status TEXT NOT NULL DEFAULT 'open', detected_at TEXT NOT NULL, resolved_at TEXT NULL, resolution TEXT NOT NULL DEFAULT '', UNIQUE(inspection_id, peer_inspection_id, finding_type))",
        "CREATE TABLE IF NOT EXISTS inspectionbillingbackup (id INTEGER PRIMARY KEY AUTOINCREMENT, inspection_id INTEGER NOT NULL UNIQUE, billing_json TEXT NOT NULL DEFAULT '{}', created_at TEXT NOT NULL)",
        "CREATE TABLE IF NOT EXISTS billingexport (id INTEGER PRIMARY KEY AUTOINCREMENT, idempotency_key TEXT NOT NULL UNIQUE, tenant_id INTEGER NULL, owner_user_id INTEGER NULL, status TEXT NOT NULL DEFAULT 'pending', inspection_ids_json TEXT NOT NULL DEFAULT '[]', invoice_id INTEGER NULL, sevdesk_invoice_id TEXT NOT NULL DEFAULT '', sevdesk_invoice_number TEXT NOT NULL DEFAULT '', error_details TEXT NOT NULL DEFAULT '', created_at TEXT NULL, updated_at TEXT NULL)",
        ...
        "CREATE TABLE IF NOT EXISTS appfailure (id INTEGER PRIMARY KEY AUTOINCREMENT, request_id TEXT NOT NULL UNIQUE, kind TEXT NOT NULL DEFAULT 'exception', exception_class TEXT NOT NULL DEFAULT '', message TEXT NOT NULL DEFAULT '', source_file TEXT NOT NULL DEFAULT '', source_line INTEGER NOT NULL DEFAULT 0, trace TEXT NOT NULL DEFAULT '', request_method TEXT NOT NULL DEFAULT '', request_path TEXT NOT NULL DEFAULT '', query_keys_json TEXT NOT NULL DEFAULT '[]', user_id INTEGER NOT NULL DEFAULT 0, created_at TEXT NOT NULL)",
        ...
        'CREATE INDEX IF NOT EXISTS idx_appfailure_created ON appfailure (created_at)',
    ];
    ...
    $columns = [
        ...
        'inspection' => [
            ...
            'started_at' => 'TEXT NULL', 'finished_at' => 'TEXT NULL', 'duration_minutes' => 'INTEGER NULL',
            'billing_device_quantity' => 'INTEGER NOT NULL DEFAULT 1', 'billing_combination_id' => "TEXT NOT NULL DEFAULT ''", 'billing_combination_relevant' => 'INTEGER NOT NULL DEFAULT 1', 'billing_combination_reason' => "TEXT NOT NULL DEFAULT ''",
        ...
        'customer' => [
            ...
            'invoice_recipient_name' => "TEXT NOT NULL DEFAULT ''", 'invoice_contact_name' => "TEXT NOT NULL DEFAULT ''", 'invoice_address_street' => "TEXT NOT NULL DEFAULT ''", 'invoice_address_zip' => "TEXT NOT NULL DEFAULT ''", 'invoice_address_city' => "TEXT NOT NULL DEFAULT ''", 'invoice_address_country' => "TEXT NOT NULL DEFAULT 'Deutschland'", 'sevdesk_contact_address_id' => "TEXT NOT NULL DEFAULT ''", 'sevdesk_contact_person_id' => "TEXT NOT NULL DEFAULT ''",
        ],
        ...
        'billinginvoice' => ['customer_id' => 'INTEGER NULL', 'tenant_id' => 'INTEGER NULL', 'sevdesk_invoice_id' => "TEXT NOT NULL DEFAULT ''", 'sevdesk_invoice_number' => "TEXT NOT NULL DEFAULT ''", 'sevdesk_url' => "TEXT NOT NULL DEFAULT ''", 'invoice_number' => "TEXT NOT NULL DEFAULT ''", 'invoice_date' => 'TEXT NULL', 'performance_date_from' => 'TEXT NULL', 'performance_date_until' => 'TEXT NULL', 'recipient_name' => "TEXT NOT NULL DEFAULT ''", 'recipient_contact_name' => "TEXT NOT NULL DEFAULT ''", 'recipient_address' => "TEXT NOT NULL DEFAULT ''", 'status' => "TEXT NOT NULL DEFAULT 'draft'", 'sevdesk_status' => "TEXT NOT NULL DEFAULT ''", 'synced_at' => 'TEXT NULL', 'cancelled_at' => 'TEXT NULL', 'raw_json' => "TEXT NOT NULL DEFAULT '{}'", 'error_details' => "TEXT NOT NULL DEFAULT ''", 'created_by' => 'INTEGER NULL', 'exported_by' => "TEXT NOT NULL DEFAULT ''", 'exported_at' => 'TEXT NULL', 'amount_net' => 'REAL NULL', 'amount_gross' => 'REAL NULL', 'created_at' => 'TEXT NULL', 'updated_at' => 'TEXT NULL'],
        'billinginvoiceitem' => ['invoice_id' => 'INTEGER NOT NULL', 'inspection_id' => 'INTEGER NOT NULL', 'device_id' => 'INTEGER NOT NULL', 'quantity' => 'REAL NOT NULL DEFAULT 1', 'regie_minutes' => 'INTEGER NOT NULL DEFAULT 0', 'regie_reason' => "TEXT NOT NULL DEFAULT ''", 'combination_id' => "TEXT NOT NULL DEFAULT ''", 'combination_relevant' => 'INTEGER NOT NULL DEFAULT 1', 'combination_reason' => "TEXT NOT NULL DEFAULT ''", 'description' => "TEXT NOT NULL DEFAULT ''", 'active' => 'INTEGER NOT NULL DEFAULT 1', 'assigned_at' => 'TEXT NULL', 'deactivated_at' => 'TEXT NULL', 'deactivation_reason' => "TEXT NOT NULL DEFAULT ''", 'source' => "TEXT NOT NULL DEFAULT 'sevdesk'", 'created_at' => 'TEXT NULL'],
        'billingexport' => ['idempotency_key' => "TEXT NOT NULL DEFAULT ''", 'tenant_id' => 'INTEGER NULL', 'owner_user_id' => 'INTEGER NULL', 'status' => "TEXT NOT NULL DEFAULT 'pending'", 'inspection_ids_json' => "TEXT NOT NULL DEFAULT '[]'", 'invoice_id' => 'INTEGER NULL', 'sevdesk_invoice_id' => "TEXT NOT NULL DEFAULT ''", 'sevdesk_invoice_number' => "TEXT NOT NULL DEFAULT ''", 'error_details' => "TEXT NOT NULL DEFAULT ''", 'created_at' => 'TEXT NULL', 'updated_at' => 'TEXT NULL'],
    ...
    R::exec('CREATE INDEX IF NOT EXISTS idx_inspectiondupreview_status ON inspectiondupreview (status, finding_type, inspection_id)');
    R::exec('CREATE INDEX IF NOT EXISTS idx_billingexport_status ON billingexport (status, updated_at)');
    ...
    if (get_app_config('billing_history_v2_initialized') !== '1') {
        $now = date(DATE_ATOM);
        $backupInsert = $isMysql ? 'INSERT IGNORE' : 'INSERT OR IGNORE';
        foreach (R::getAll("SELECT id, billable, billing_exported_at, billing_export_id, billing_exported_by, billing_eligibility, billing_status, billing_active_invoice_item_id, billing_last_error, billing_last_export_id FROM inspection") as $row) {
            R::exec($backupInsert . ' INTO inspectionbillingbackup (inspection_id, billing_json, created_at) VALUES (?, ?, ?)', [(int) $row['id'], json_encode($row, JSON_UNESCAPED_UNICODE), $now]);
        }
        foreach (R::getAll("SELECT id FROM inspection WHERE COALESCE(public_id, '') = ''") as $row) {
            R::exec('UPDATE inspection SET public_id = ? WHERE id = ? AND public_id = ?', ['prf_' . bin2hex(random_bytes(16)), (int) $row['id'], '']);
        }
        set_app_config('billing_history_v2_initialized', '1');
    }
    R::exec('CREATE UNIQUE INDEX IF NOT EXISTS idx_inspection_public_id_unique ON inspection (public_id)');
