...
function ensure_structure_schema(): void
{
    ...
    $columns = [
        ...
        'customer' => [
            ...
            'invoice_recipient_name' => "TEXT NOT NULL DEFAULT ''", 'invoice_contact_name' => "TEXT NOT NULL DEFAULT ''", 'invoice_address_street' => "TEXT NOT NULL DEFAULT ''", 'invoice_address_zip' => "TEXT NOT NULL DEFAULT ''", 'invoice_address_city' => "TEXT NOT NULL DEFAULT ''", 'invoice_address_country' => "TEXT NOT NULL DEFAULT 'Deutschland'",
        ],
